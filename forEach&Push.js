// Challenge: write a function that uses the Array.prototype.forEach() & the Array.prototype.push() methods within it. Before writing your function, declare a variable of 'copy' that is initialized as an empty array. Using the forEach method, loop over all of the presidents from our presidents array. Then, push the president's last name and the year they were born to our copy array as individual objects containing key/value pairs of each presidents respective last name and date of birth. Then console.log our copy array.
...
fn();
// really useful for creating an api and displaying specific information.
