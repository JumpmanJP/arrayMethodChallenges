...
let x = presidents.reduce ((accumulator, cV) => {

if(cV.passed == undefined){
    return accumulator + 2019 - cV.year
} else { 
    return accumulator + cV.passed - cV.year
}
},0);
...
let initialValue = 0;
let years = presidents.reduce(function(accumulator, currentValue) {
   if(isNaN(currentValue.passed) === true) {
       return accumulator + 2019 - currentValue.year
   } else {
...
let years1 = presidents.reduce((accumulator, currentValue) => {
   if(isNaN(currentValue.passed) === true) {
       return accumulator + 2019 - currentValue.year
   } else {
       return accumulator + currentValue.passed - currentValue.year;
...
let years2 = presidents.reduce((accumulator, currentValue) => isNaN(currentValue.passed) === true ? accumulator + 2019 - currentValue.year : accumulator + currentValue.passed - currentValue.year,0)
console.log(years2)